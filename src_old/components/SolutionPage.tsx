...
import heroImage from 'figma:asset/05a08b2bcf011c661c3f025f7710ddff6f4dc875.png';
...
export default function SolutionPage({
  ...
  return (
    <motion.div 
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="fixed inset-0 z-[9998] bg-[#fafaf8] overflow-y-auto"
    >
      {/* Desktop Header */}
      ...
      {/* Main Content */}
      <div className="min-h-screen lg:pt-[90px]">
