...
// FIXED: Changed to div with onClick instead of button
function SocialIcon({ icon: Icon, onClick }: { icon: React.ComponentType; onClick?: () => void }) {
    return (
        <div
            role="button"
            tabIndex={0}
            ...
            className="w-9 h-9 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center transition cursor-pointer focus:outline-none focus:ring-2 focus:ring-[#b2833a] focus:ring-offset-2"
        >
            <Icon />
        </div>
    );
