...
export default function ProductDetailPage({ onClose, wishlistCount = 0, onWishlistClick, source = 'shop', onStyleFinderClick, onContactClick, onAboutClick, onBlogClick, onSolutionClick, onBodyShapeGuideClick }: ProductDetailPageProps) {
  ...
  const handleImageUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (files && reviewImages.length < 5) {
  ...
  const handleAddToWishlist = () => {
    const product = {
      id: 'hoodie-001', // Unique product ID
    ...
    // Dispatch custom event to update count in header
        ...
        >
          <div className="flex items-center justify-between mb-8">
            ...
            <motion.button
              ...
              className="px-6 py-3 bg-white border-2 border-[#b2833a] text-[#b2833a] rounded-full hover:bg-[#b2833a] hover:text-white transition-all"
            >
              Write a Review
            </motion.button>
          </div>
          ...
          <AnimatePresence>
            {showReviewForm && (
              <motion.div
                ...
                className="mb-8 bg-gray-50 rounded-2xl p-6 overflow-hidden"
              >
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      ...
                      <label className="flex items-center justify-center gap-2 px-4 py-3 border-2 border-dashed border-gray-300 rounded-xl cursor-pointer hover:border-[#b2833a] hover:bg-gray-50 transition-all">
                        ...
                        <span className="text-sm text-gray-600">
                          Upload images {reviewImages.length > 0 && `- ${reviewImages.length} selected`}
                        </span>
                        <input
                          type="file"
                          accept="image/*"
                    ...
                    <div className="flex items-center gap-2 flex-wrap">
                      {review.images.map((image, imgIndex) => (
                        <motion.button
                          ...
                          className="relative w-16 h-16 sm:w-20 sm:h-20 rounded-lg overflow-hidden border-2 border-gray-200 hover:border-[#b2833a] transition-all group"
                        >
                          <img
                            src={image}
