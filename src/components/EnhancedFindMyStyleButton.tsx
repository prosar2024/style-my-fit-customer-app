...
interface EnhancedFindMyStyleButtonProps {
  onClick?: () => void;
}

export function EnhancedFindMyStyleButton({ onClick }: EnhancedFindMyStyleButtonProps) {
  ...
  return (
    <div className="relative inline-block">
      ...
      <motion.button
        ...
        className="relative bg-gradient-to-r from-[#b2833a] to-[#D38436] text-white font-['Poppins:SemiBold',sans-serif] text-[18px] px-8 py-4 rounded-[40px] shadow-[0px_20px_40px_0px_rgba(178,131,58,0.35)] overflow-hidden cursor-pointer border-2 border-white/20"
        whileHover={{
          scale: 1.05,
          boxShadow: "0px 25px 50px 0px rgba(178,131,58,0.5)",
        }}
        whileTap={{ scale: 0.98 }}
      ...
      >
        ...
        <div className="relative flex items-center gap-3 justify-center">
          ...
          >
            <svg className="w-4 h-4" fill="white" viewBox="0 0 12 8">
