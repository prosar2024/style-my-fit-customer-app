...
import heroImage from 'figma:asset/bf9df4d72f123b2642725d8484faf976719f85e2.png';
...
export default function BodyShapeGuide({ 
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="fixed inset-0 z-[9998] bg-[#F9F9F9] overflow-y-auto"
    >
      {/* Desktop Header */}
      <div className="hidden lg:block fixed top-0 left-0 right-0 z-50 bg-white shadow-sm">
        <DesktopHeader 
          ...
          onBodyShapeGuideClick={onClose}
          wishlistCount={wishlistCount}
          activePage="body-shape-guide"
        />
      </div>
      ...
      {/* Hero Section */}
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden lg:pt-[90px]">
        {/* Background Image */}
